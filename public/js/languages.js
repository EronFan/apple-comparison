...
const languageResources = {
  'zh-CN': {
    ...
    'bench.subtitle': '汇总站内已公开的 Geekbench 跑分，按分数排名',
    ...
    // 页脚
    'article.authorBio': '专注于苹果产品评测、参数对比和深度分析的专业团队。',
    'article.commentPlaceholder': '写下你的评论…',
    'article.comments': '评论',
    'article.emailPlaceholder': '邮箱（选填）',
    'article.loadMore': '加载更多',
    'article.newsletter': '订阅更新',
    'article.newsletterDesc': '第一时间获取新机参数与评测。',
    'article.page.title': '文章详情 - Apple参数大全',
    'article.postComment': '发表评论',
    'article.relatedArticles': '相关文章',
    'article.relatedProducts': '相关产品',
    'article.reply': '回复',
    'article.save': '收藏',
    'article.share': '分享',
    'article.subscribe': '订阅',
    'article.tags': '标签',
    'article.viewSpecs': '查看详细参数',
    ...
    'news.categories': '文章分类',
    'news.category.all': '全部',
    'news.category.comparisons': '产品对比',
    'news.category.guides': '使用指南',
    'news.category.news': '新闻动态',
    'news.category.reviews': '产品评测',
    'news.category.rumors': '传闻爆料',
    'news.featured': '精选',
    'news.page.title': '苹果资讯 - Apple参数大全',
    'news.products': '相关产品',
    'news.readMore': '阅读全文',
    'news.search.placeholder': '搜索文章...',
    'news.title': '苹果资讯',
    'product.ios.title': 'iOS',
    'product.macos.title': 'macOS',
  ...
  'en-US': {
    ...
    'bench.subtitle': 'Geekbench scores from our database, ranked',
    ...
    // Footer
    'article.authorBio': 'A team focused on Apple product reviews and comparisons.',
    'article.commentPlaceholder': 'Write your comment...',
    'article.comments': 'Comments',
    'article.emailPlaceholder': 'Email (optional)',
    'article.loadMore': 'Load more',
    'article.newsletter': 'Subscribe for updates',
    'article.newsletterDesc': 'Get new specs and reviews first.',
    'article.page.title': 'Article - Apple Specs Library',
    'article.postComment': 'Post comment',
    'article.relatedArticles': 'Related articles',
    'article.relatedProducts': 'Related products',
    'article.reply': 'Reply',
    'article.save': 'Save',
    'article.share': 'Share',
    'article.subscribe': 'Subscribe',
    'article.tags': 'Tags',
    'article.viewSpecs': 'View specs',
    ...
    'news.category.comparisons': 'Comparisons',
    'news.category.guides': 'Guides',
    'news.category.news': 'News',
    'news.category.reviews': 'Reviews',
    'news.category.rumors': 'Rumors',
    'news.featured': 'Featured',
    'news.page.title': 'News - Apple Specs Library',
    'news.products': 'Related products',
