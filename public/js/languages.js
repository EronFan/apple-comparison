...
const languageResources = {
  'zh-CN': {
    ...
    'bench.mode.avg': '均值',
    'nav.battery': '电池榜',
    'battery.title': 'iPhone 电池容量天梯图',
    'battery.subtitle': '历代 iPhone 电池容量排名，按梯队划分，谁是大电池一目了然',
    'battery.tab.all': '全部',
    ...
    'battery.empty': '暂无数据',
    'battery.note': '电池容量为官方标称典型值（mAh），同时标注瓦时（Wh）与发布年份；仅收录 iPhone 机型。',
    'product.battery.title': '电池天梯图',
    'product.battery.description': '历代 iPhone 电池容量排行，谁是大电池一目了然',
  ...
  'en-US': {
    ...
    'nav.battery': 'Battery',
    'battery.title': 'iPhone Battery Capacity Ladder',
    'battery.subtitle': 'Every iPhone ranked by battery capacity, grouped into tiers',
    'battery.tab.all': 'All',
    ...
    'battery.note': 'Capacities are official typical values (mAh), with Wh and release year shown for reference. iPhone models only.',
    'product.battery.title': 'Battery Ladder',
    'product.battery.description': 'Rank every iPhone by battery capacity',
